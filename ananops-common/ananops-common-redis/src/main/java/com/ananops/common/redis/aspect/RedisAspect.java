package com.ananops.common.redis.aspect;
...
import com.ananops.common.redis.annotation.RedisEvict;
...
public class RedisAspect
{
     ...
     */
    @Pointcut("@annotation(com.ananops.common.redis.annotation.RedisCache)")
    public void redisCachePoint()
    {
    }

    @Pointcut("@annotation(com.ananops.common.redis.annotation.RedisEvict)")
