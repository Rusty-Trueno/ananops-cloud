package com.ananops.core.registry.zookeeper;
...
/**
 * 基于Zookeeper的注册中心.
 * 生成zookeeper客户端操作类CuratorFramework
 * @author zhangliang
 */
@Slf4j
public final class ZookeeperRegistryCenter implements CoordinatorRegistryCenter {
	...
	public void init() {
		...
		//Curator 建造者模式创建zookeeper客户端
		CuratorFrameworkFactory.Builder builder = CuratorFrameworkFactory.builder()
				//参数1 zookeeper服务器列表
				.connectString(zkConfig.getZkAddressList())
				//参数2 retryPolicy 重试策略
				//ExponentialBackoffRetry（重试指定的次数且每次重试之间停顿的时间逐渐增加）
