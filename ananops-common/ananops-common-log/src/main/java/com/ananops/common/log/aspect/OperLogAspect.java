package com.ananops.common.log.aspect;
...
import com.ananops.common.log.enums.BusinessStatus;
import com.ananops.common.log.event.SysOperLogEvent;
...
{
    // 配置织入点
    @Pointcut("@annotation(com.ananops.common.log.annotation.OperLog)")
