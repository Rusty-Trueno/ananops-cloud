...
/**
 * 巡检任务日志对象 an_imc_inspection_task_log
 * 
 * @author ananops
 * @date 2020-05-22
 */
public class AnImcInspectionTaskLog extends BaseEntity
{
    ...
    /** 操作对应的时间戳 */
    @Excel(name = "操作对应的时间戳", width = 30, dateFormat = "yyyy-MM-dd")
    private Date statusTimestamp;

    /** 当前操作对应的描述（有可能不存在） */
    @Excel(name = "当前操作对应的描述", readConverterExp = "有=可能不存在")
    private String movement;

    /** $column.columnComment */
    @Excel(name = "当前操作对应的描述", readConverterExp = "$column.readConverterExp()")
    private String os;
