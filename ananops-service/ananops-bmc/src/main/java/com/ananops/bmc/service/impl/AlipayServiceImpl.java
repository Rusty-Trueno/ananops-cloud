...
import com.ananops.bmc.alipay.Alipay;
import com.ananops.bmc.alipay.AlipayBean;
import com.ananops.bmc.domain.AnBmcBill;
import com.ananops.bmc.mapper.AnBmcBillMapper;
import com.ananops.bmc.service.AlipayService;
...
public class AlipayServiceImpl implements AlipayService {
    ...
    @Resource
    private AnBmcBillMapper bmcBillMapper;
    ...
    public void notify(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        AnBmcBill bmcBill = bmcBillMapper.selectByPrimaryKey(billNum);
