 ...
 * @date 2020-05-22
 */
public interface AnImcInspectionReviewMapper extends BaseMapper<AnImcInspectionReview>
{
    /**
     * 查询巡检任务评论
     * 
     ...
     * @return 结果
     */
    public int insertAnImcInspectionReview(AnImcInspectionReview anImcInspectionReview);
