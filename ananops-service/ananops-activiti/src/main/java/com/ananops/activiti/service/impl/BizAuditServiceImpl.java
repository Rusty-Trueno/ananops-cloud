...
import com.ananops.activiti.mapper.BizAuditMapper;
...
public class BizAuditServiceImpl implements IBizAuditService
{
    ...
    /* (non-Javadoc)
     * @see com.ananops.activiti.service.IBizAuditService#getHistoryTaskList(com.ananops.activiti.vo.HiTaskVo)
     */
    @Override
