package com.ananops.generator.controller;
...
import com.ananops.common.log.annotation.OperLog;
import com.ananops.common.log.enums.BusinessType;
import com.ananops.generator.domain.GenTable;
import com.ananops.generator.domain.GenTableColumn;
import com.ananops.generator.service.IGenTableColumnService;
import com.ananops.generator.service.IGenTableService;
 ...
 */
@RestController
@Api(value = "WEB - gen",produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
public class GenController extends BaseController
{
    ...
    @GetMapping("/list")
    @ApiOperation(httpMethod = "GET",value = "genList")
    ...
    @ApiOperation(httpMethod = "GET",value = "getTable")
    ...
    @HasPermissions("tool:gen:list")
    @GetMapping("/db/list")
    @ApiOperation(httpMethod = "GET",value = "getData")
    ...
    @GetMapping("edit")
    @ApiOperation(httpMethod = "GET",value = "edit")
    ...
    @ApiOperation(httpMethod = "POST",value = "import")
    ...
    @PostMapping("/edit")
    @ApiOperation(httpMethod = "POST",value = "edit")
    ...
    @PostMapping("/remove")
    @ApiOperation(httpMethod = "POST",value = "remove")
    ...
    @ApiOperation(httpMethod = "POST",value = "preview")
    ...
    @ApiOperation(httpMethod = "POST",value = "代码生成")
    ...
    @ApiOperation(httpMethod = "POST",value = "批量生成代码")
    ...
    {
        response.reset();
        response.setHeader("Content-Disposition", "attachment; filename=ananops.zip");
